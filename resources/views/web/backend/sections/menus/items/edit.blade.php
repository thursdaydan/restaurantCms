...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active">@lang('sections/items.action.edit')</li>
@endsection
        ...
        <div class="row">
            <div class="col-12">
                <form role="form" method="POST" action="{{ route('items.update', $item->id) }}">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('sections/items.fields.pricing')</h3>
                        </div>
                        ...
                        <div class="card-body row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="notes" id="notes" class="form-control" rows="5" placeholder="Notes">{{ old('notes', $item->notes) }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group" style="min-height: 70px;">
                                    <label for="gluten_free">@lang('sections/items.fields.dietary_options')s</label> <br />
